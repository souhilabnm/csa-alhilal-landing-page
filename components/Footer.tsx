    ...
    <footer id="contact" className="bg-white pt-12 md:pt-24 pb-8 md:pb-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 md:mb-20">
            {/* Phone Card */}
            <a href="tel:+213555000000" className="group relative bg-white border border-gray-100 rounded-3xl p-8 hover:shadow-xl hover:shadow-brand-deep/5 transition-all duration-500 hover:-translate-y-2 flex flex-col shadow-sm">
                ...
                <div className="flex items-center justify-between mt-auto">
                    <span className="text-lg text-brand-dark font-medium">+213 555 00 00 00</span>
            ...
            {/* Location Card */}
            <a href="#" className="group relative bg-white border border-gray-100 rounded-3xl p-8 hover:shadow-xl hover:shadow-brand-deep/5 transition-all duration-500 hover:-translate-y-2 flex flex-col shadow-sm">
                <div className="w-14 h-14 rounded-2xl bg-brand-primary/10 flex items-center justify-center text-brand-primary mb-8 group-hover:scale-110 transition-transform duration-500">
                    <MapPin size={28} />
                </div>
